...
rustc test_parserutils_inputstream.rs -L . -L ../libparserutils -L ../libcss -L ../libwapcaplet
rustc test_parserutils.rs -L . -L ../libparserutils -L ../libcss -L ../libwapcaplet
#rustc -L ./.. test_riconv.rs -L .
rustc test_wapcaplet.rs -L . -L ../libwapcaplet
rustc test_csdtect.rs -L . -L ../libparserutils -L ../libcss -L ../libwapcaplet
...
rustc --test test_lexer_chunks_file.rs -L . -L ../libparserutils -L ../libcss -L ../libwapcaplet
cd libcss
./make_test.sh
cd ..
cd libparserutils
