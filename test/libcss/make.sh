...
rustc -L ../../libparserutils -L ../../libcss -L ../../libwapcaplet dump2.rs -O
rustc -L ../../libparserutils -L ../../libcss -L ../../libwapcaplet dump_computed.rs -O
...
rustc --test -L ../../libparserutils -L ../../libcss -L ../../libwapcaplet -L . select-auto.rs -O