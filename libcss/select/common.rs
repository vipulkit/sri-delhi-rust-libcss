...
pub struct css_select_handler {
    ...
    node_name: extern fn( node:Option<@mut node>, qname: &mut css_qname ) -> css_error,

    node_classes: extern fn(lwc_ref:&mut ~lwc, pw:@mut ctx_pw, n:Option<@mut node>, classes: &mut ~[uint] ) -> css_error,

    node_id: extern fn(lwc_ref:&mut ~lwc, pw:@mut ctx_pw, node:Option<@mut node>, id:&mut uint ) -> css_error,

    named_ancestor_node: extern fn(lwc_ref:&mut ~lwc, node:Option<@mut node>, qname:&mut css_qname, ancestor:&mut Option<@mut node>) -> css_error,
   
    named_parent_node: extern fn(lwc_ref:&mut ~lwc, node:Option<@mut node>, qname:&mut css_qname, parent:&mut Option<@mut node>) -> css_error,
    
    named_sibling_node: extern fn(lwc_ref:&mut ~lwc, node:Option<@mut node>, qname:&mut css_qname, sibling:&mut Option<@mut node>) -> css_error,

    named_generic_sibling_node: extern fn(lwc_ref:&mut ~lwc, node:Option<@mut node>, qname:&mut css_qname, sibling:&mut Option<@mut node>) -> css_error,
    
    parent_node: extern fn(node:Option<@mut node>, parent:&mut Option<@mut node>) -> css_error,

    sibling_node: extern fn(node:Option<@mut node>, sibling:&mut Option<@mut node>) -> css_error,

    node_has_name: extern fn(lwc_ref:&mut ~lwc, pw:@mut ctx_pw,node:Option<@mut node>, qname:&css_qname, matched:&mut bool) -> css_error,

    node_has_class: extern fn(lwc_ref:&mut ~lwc, pw:@mut ctx_pw, node:Option<@mut node>, name:uint, matched:&mut bool) -> css_error,

    node_has_id: extern fn(lwc_ref:&mut ~lwc, pw:@mut ctx_pw, node:Option<@mut node>, name:uint, matched:&mut bool) -> css_error,

    node_has_attribute: extern fn(lwc_ref:&mut ~lwc, node:Option<@mut node>, name:&css_qname, matched:&mut bool) -> css_error,
    
    node_has_attribute_equal: extern fn(lwc_ref:&mut ~lwc, node:Option<@mut node>, qname:&css_qname,value:uint, matched:&mut bool) -> css_error,
   
    node_has_attribute_dashmatch: extern fn(lwc_ref:&mut ~lwc, node:Option<@mut node>, qname:&css_qname,value:uint, matched:&mut bool) -> css_error,

    node_has_attribute_includes: extern fn(lwc_ref:&mut ~lwc, node:Option<@mut node>, qname:&css_qname,value:uint, matched:&mut bool) -> css_error,

    node_has_attribute_prefix: extern fn(lwc_ref:&mut ~lwc, node:Option<@mut node>, qname:&css_qname,value:uint, matched:&mut bool) -> css_error,

    node_has_attribute_suffix: extern fn(lwc_ref:&mut ~lwc, node:Option<@mut node>, qname:&css_qname,value:uint, matched:&mut bool) -> css_error,

    node_has_attribute_substring: extern fn(lwc_ref:&mut ~lwc, node:Option<@mut node>, qname:&css_qname,value:uint, matched:&mut bool) -> css_error,

    node_is_root: extern fn(node:Option<@mut node>, matched:&mut bool) -> css_error,
   
    node_count_siblings: extern fn(lwc_ref:&mut ~lwc, node:Option<@mut node>, same_name:bool, after:bool, count:&mut i32) -> css_error,
    
    node_is_empty: extern fn(node:Option<@mut node>, matched:&mut bool) -> css_error,
    
    node_is_link: extern fn(node:Option<@mut node>, matched:&mut bool) -> css_error,

    node_is_visited: extern fn(node:Option<@mut node>, matched:&mut bool) -> css_error,

    node_is_hover: extern fn(node:Option<@mut node>, matched:&mut bool) -> css_error,

    node_is_active: extern fn(node:Option<@mut node>, matched:&mut bool) -> css_error,

    node_is_focus: extern fn(node:Option<@mut node>, matched:&mut bool) -> css_error,

    node_is_enabled: extern fn(node:Option<@mut node>, matched:&mut bool) -> css_error,

    node_is_disabled: extern fn(node:Option<@mut node>, matched:&mut bool) -> css_error,

    node_is_checked: extern fn(node:Option<@mut node>, matched:&mut bool) -> css_error,
 
    node_is_target: extern fn(node:Option<@mut node>, matched:&mut bool) -> css_error,

    node_is_lang: extern fn(node:Option<@mut node>, lang:uint, matched:&mut bool) -> css_error,

    node_presentational_hint: extern fn(node:Option<@mut node>, property:u32) -> 
